...
namespace projekt
{
    public partial class Form1 : Form
    {
        ...
        private void sprawdz()
        {
            ...
            {
                MessageBox.Show("Brawo znalazles pare, twoja liczba ruchów wynosi: " + ruchy);
            ...
            if( odkryte == 16) { MessageBox.Show("Wygra³eœ");
            }
        } 
